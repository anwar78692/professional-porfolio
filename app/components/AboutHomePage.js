    ...
    return (
      <Section>
        ...
        >
          ...
          <a href="mailto:anwar15298@gmail.com">
            <Button>Say Hello</Button>
          </a>
          <GridContainer>
          <GridItem><SpanStyled>2 Y.</SpanStyled>
          <SpanText>Experience</SpanText>
          </GridItem>
          <GridItem><SpanStyled>15 +</SpanStyled><SpanText>Projects completed</SpanText></GridItem>
          <GridItem><SpanStyled>30</SpanStyled> <SpanText>Happy Clients</SpanText></GridItem>
        </GridContainer>
        </LeftContainer>
        <RightContainer
          initial={{ opacity: 0.8 }}
